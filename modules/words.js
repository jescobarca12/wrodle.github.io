// modules/words.js
// Lista de palabras del juego + función para la palabra del día
...
/**
 * Devuelve la palabra del día de forma determinística.
 * La misma palabra para todos los jugadores ese día.
 */
export function getWordOfDay() {
  const LAUNCH = new Date('2026-05-02T00:00:00');
  const today = new Date();
  today.setHours(0, 0, 0, 0);
  const diff = Math.floor((today - LAUNCH) / 86_400_000);
